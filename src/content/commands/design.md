...
nothing here to remember. Then say: "The specs and delivery sequence are locked. Ready to **Build**? Run `{{ ns }}build` — I'll present a delivery plan first, then deliver the specs."
{%- if command_format == "toml" %}
"""
{%- endif %}
