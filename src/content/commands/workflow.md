...
---
{%- if command_name %}
name: {{ command_name_prefix }}workflow
{%- endif %}
description: Guided end-to-end delivery — all four Hercules phases in one flow
...
Run the full `{{ ns }}discover` flow (Steps 0–8). When all six discovery groups (Problem, Actors, Main flow & scope, Failure modes, Constraints, Done) are covered, complexity is classified, and the `*-business-requirements.md` draft is approved, saved and reviewed, pause:
