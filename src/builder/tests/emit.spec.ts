...
// string write() ever writes) — same pattern as builder/tests/versionTargets.spec.ts's own
...
import { EmitError, copyMap, copyVersioned, readSource, write } from '../emit.mjs';
