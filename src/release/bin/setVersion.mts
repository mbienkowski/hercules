 ...
 * module it guards is a branch no unit test can exercise, so isolating it here keeps setVersion.mts
 * fully mutation-covered — same rationale as mutationGate.mts's own shim.
 */
