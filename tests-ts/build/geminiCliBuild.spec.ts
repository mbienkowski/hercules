...
import { readCanonicalVersion } from '../../scripts-ts/build/versionTargets.mjs';
...
// verbatim (same tomlBasic/tomlMultiline pins) by tests-ts/build/genSerialize.spec.ts's
