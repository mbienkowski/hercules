...
// A SEPARATE spec file, deliberately — see tests-ts/build/layoutSort.spec.ts for the full
...
const { discover, distFiles } = await import('../../scripts-ts/build/descriptor.mjs');
