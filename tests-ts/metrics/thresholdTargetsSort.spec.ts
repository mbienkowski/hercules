...
// tests-ts/build/descriptorSort.spec.ts for the full rationale). In short: Node's own fs.globSync
...
const { resolveTargets } = await import('../../scripts-ts/metrics/thresholdRunner.mjs');
