...
// tests-ts/build/descriptorSort.spec.ts for the full rationale, and
// tests-ts/metrics/thresholdTargetsSort.spec.ts for why an unmocked directory can't prove this:
...
const { resolveChains } = await import('../../scripts-ts/metrics/loadingChains.mjs');
