...
// vi.mock('node:fs') is module-scoped and hoisted (see tests-ts/build/descriptorSort.spec.ts for
...
import { readVersions } from '../../scripts-ts/build/versionTargets.mjs';
