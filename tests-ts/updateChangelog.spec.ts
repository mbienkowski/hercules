...
// vi.mock('node:child_process') is module-scoped and hoisted (see tests-ts/build/descriptorSort.spec.ts
...
import { formatEntry, getCommitsSince, main, updateChangelog } from '../scripts-ts/updateChangelog.mjs';
