 ...
 * `src/content/`, so a file carrying one of these characters would compile differently under the
 ...
 * CPython and pinned by tests-ts/build/pyCompat.spec.ts.
 */
 ...
 *
 * Generated from tests/testdata/pycompat-golden.json by scripts/ci/gen_pycompat_golden.py and
 * asserted against it in tests-ts/build/pyCompat.spec.ts, so a hand-edit cannot drift from the
