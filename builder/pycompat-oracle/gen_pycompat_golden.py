...
builder/pyCompat.mts reproduces Python's ``str.isspace()``, ``str.splitlines()`` and
...
Usage:
    python builder/pycompat-oracle/gen_pycompat_golden.py [output-path]
...
def build() -> dict[str, object]:
    return {
        "_comment": [
            "Generated from CPython by builder/pycompat-oracle/gen_pycompat_golden.py. The TypeScript pyCompat",
