...
3. **Scan** — `python3 ${GROK_PLUGIN_ROOT}/tools/code_of_conduct/coc_scan.py all --root <root> --contract 1`.
...
7. **Gate & present** — the gate is a program, not a promise.
   ...
   - Pipe it to `python3 ${GROK_PLUGIN_ROOT}/tools/code_of_conduct/coc_audit.py draft --contract 1`.
