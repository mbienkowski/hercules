...
```
python3 ${GROK_PLUGIN_ROOT}/tools/project_reset.py plan --contract 1
```
...
```
python3 ${GROK_PLUGIN_ROOT}/tools/project_reset.py apply --contract 1 --confirm --documents --feature 2026-07-29-one-dynamic-workflow
```
