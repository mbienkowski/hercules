...
## Output
Replies follow the A2A Communication Protocol § Agent-Injected Core (`${GROK_PLUGIN_ROOT}/protocols/a2a-communication-protocol.md`): `[DESIGNER] STATUS | CONTENT | ACTION`.
