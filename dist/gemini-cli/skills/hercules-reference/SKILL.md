...
(`directory`); when Gemini is launched in a docs/requirements repo whose code lives elsewhere, the
...
Full orchestrator mechanics: [${extensionPath}/protocols/debate-consensus-protocol.md](${extensionPath}/protocols/debate-consensus-protocol.md).
For debates involving built-in Explore/Plan/Workflow agents, prepend the full
`${extensionPath}/protocols/debate-consensus-protocol.md` to the per-call delegation prompt.
