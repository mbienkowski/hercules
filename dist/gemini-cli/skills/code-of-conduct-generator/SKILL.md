...
3. **Scan** — run `python3 ${extensionPath}/tools/coc_scan.py all --root <root> --contract 1` for the
...
`python3 ${extensionPath}/tools/coc_audit.py existing --contract 1 --file <coc> --root <root>` reports
