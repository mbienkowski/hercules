...
**Plan mode — required.** Open with `EnterPlanMode`; at each **Plan approval** gate, call `ExitPlanMode` (`auto`) before writing/executing. Never patch sections — regenerate full drafts.
