...
Read [${CLAUDE_PLUGIN_ROOT}/protocols/a2a-communication-protocol.md](${CLAUDE_PLUGIN_ROOT}/protocols/a2a-communication-protocol.md) before spawning any sub-agent.
...
Step order and hard guardrails are normatively listed in `${CLAUDE_PLUGIN_ROOT}/protocols/workflow-protocol.md`;
