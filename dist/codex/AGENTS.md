...
Hercules is a Codex plugin of agents, commands, and skills, distributed through the native
plugin marketplace.
...
6. Open Codex where documents live: monorepo → open in that repo; microservices with cross-repo features → use a dedicated requirements repo.
