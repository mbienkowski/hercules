...
```
python3 tools/probe_run.py run --label {assumption} --tier {tier} \
...
Section depth follows the tier — `python3 tools/doc_lint.py template --kind spec
...
(`python3 tools/doc_report.py rubric`), writing its answers beside the spec as
