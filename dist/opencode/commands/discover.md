...
(`protocols/workflow-protocol.md#packet`).
It reads the document **directly** and answers every category in the rubric
(`python3 tools/doc_report.py rubric` prints them; `… template --kind
