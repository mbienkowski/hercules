...
## Output
Replies follow the A2A Communication Protocol § Agent-Injected Core (`${HERCULES_PLUGIN_ROOT}/protocols/a2a-communication-protocol.md`): `[DEVOPS] STATUS | CONTENT | ACTION`.
